	...
	public String toString() {
		...
		if (occupation != null) {
			...
			if (type != STANDARD && occupation.isDataServiceRequired()) {
				dataServiceInfo += " Data service: In used (Ethernet address: " + occupation.getEthernetAddress() + ")";
			}
		...
		return "Room No: " + floorNo + "-" + roomNo + ", Room Type: " + getTypeString() + ", Capacity: " + capacity
				+ ", Rate: " + rate + dataServiceInfo + ", Occupant: " + occupantInfo;
	}
}