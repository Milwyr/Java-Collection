...
public class CheckOutPanel extends JPanel {
	...
	public void getCommandValues() {
		ArrayList<Room> list = hotelManager.listAllOccupiedRooms();
		...
		occupiedRoomTable.setModel(new AbstractTableModel() {
			...
			public Object getValueAt(int r, int c) {
				...
				case 4:
					if (room.getType() == 1) {
						return "N/A";
					} else if (occupation.isDataServiceRequired()) {
						return "In used";
					} else {
						return "Not in used";
					}
				case 5:
					return occupation.getEthernetAddress();
				case 6:
				...
				case 10:
					return new SimpleDateFormat("dd-MM-yyyy").format(occupation.getCheckInDate());
				}
				return "";
			}
