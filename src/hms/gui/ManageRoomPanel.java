					...
					updateBtn.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							try {
								...
								// JOptionPane.showMessageDialog(null, "Rate not
								// correctly set!", "Error",
							...
							if (newRate > 0 && newDiscount >= 0 && newDiscount < 100) {
								...
								boolean result = hotelManager.updateRoomRate(command.getSelectedRoom(),
										finalRate.intValue());
								if (result) {
									if (roomInfoPanel != null) {
										controlPanel.remove(roomInfoPanel);
