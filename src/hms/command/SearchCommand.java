...
/**
 * The class SearchCommand encapsulates functions for searching
...
public class SearchCommand implements Command {
	...
	/**
	 * Gets the search field type. Possible types are: customer ID, customer
	 * name, customer's company and room type
	 * 
	 * @return the type
	 */
