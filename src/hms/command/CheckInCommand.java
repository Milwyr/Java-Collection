...
public class CheckInCommand implements Command {
	 ...
	 *            the boolean value indicating whether data service is required
	 */
	public void setDataServiceRequired(boolean dataServiceRequired) {
	...
	public String checkIn() {
		String result = hotelManager.checkIn(ID, name, type, company, checkInDate, dataServiceRequired, ethernetAddress,
				selectedRoom);
	...
	public Date getCurrentDate() {
		try {
			return new SimpleDateFormat("dd-MM-yyyy")
					.parse(new SimpleDateFormat("dd-MM-yyyy").format(new GregorianCalendar().getTime()));
		} catch (ParseException e) { // Never happens
			return null;
		}
	}
}